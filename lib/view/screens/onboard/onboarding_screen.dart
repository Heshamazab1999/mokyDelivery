          ...
          Center(child: SizedBox(width: MediaQuery.of(context).size.width, child: Stack(
            children: [
              ...
              Positioned(bottom: 70,child: Align(
                ...
                child: SizedBox(width: 100, child: Image.asset(Images.leftBox,color: Theme.of(context).primaryColor,)),)),
              Positioned(child: Align(
                alignment: Alignment.bottomRight,
                child: SizedBox(width: 100, child: Image.asset(Images.rightBox,color: Theme.of(context).primaryColor)),)),
            ],
          ))) : const SizedBox();
        }
      ),
